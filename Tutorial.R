...
##############################################################
#
# Reference: Matzke, Nicholas J. (2014). "Introduction to R, starting from scratch." 
# 2014 Summer Research Experiences (SRE) at NIMBioS for Undergraduates and Teachers. 
# Given Monday, June 16, 9-11 am, Claxton 206, National Institute of 
# Mathematical and Biological Science (NIMBioS).
# http://nimbios.org/sre/sre2014
# 
...
#######################################################
# CHAPTER 7 (BONUS): AN EXAMPLE USING ALL OF THE ABOVE 
# WITH BIOGEOGRAPHY
#
